...
| 17 октября  |  07   | <ul><li>Проектирование кода</li><li>Шаблоны проектирования</li></ul>                                | [Проектирование кода](Seminars/07-oop/oop.ipynb)                                       | Контест 4: Декораторы, итераторы, классы                                                                       |
