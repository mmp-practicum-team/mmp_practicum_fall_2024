# Курс "Практикум на ЭВМ 2024/2025" для бакалавров 3 курса кафедры ММП ВМК МГУ, осенний семестр

Этот репозиторий содержит материалы к курсу "Практикум на ЭВМ", читаемому бакалаврам 3 курса кафедры ММП факультета ВМК МГУ в осеннем семестре 2024 года.
...
- Курс читается в поддержку курса "Математические методы распознавания образов" (машинное обучение, часть 1), читаемого на кафедре ММП
  ...
  - [Курс семинаров по машинному обучению](https://github.com/mmp-mmro-team/mmp_mmro_fall_2023)
...
- Большие практические задания [выкладываются здесь](https://github.com/mmp-practicum-team/mmp_practicum_fall_2024/tree/master/Tasks)
...
| :---------: | :---: | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| 05 сентября |  01   | <ul><li>Введение в Python</li></ul>                                                                 | [Введение в Python](Seminars/01-intro/intro.ipynb)                                     | [Контест 1: Введение в язык Python](https://contest.yandex.ru/contest/67651/enter)                             |
| 12 сентября |  02   | <ul><li>Организация кода в Python: функции, модули, классы</li><li>Итераторы и генераторы</li></ul> | [Функции, модули, классы. Итераторы и генераторы](Seminars/02-code-org/code-org.ipynb) | [Контест 2: Классы, генераторы](https://contest.yandex.ru/contest/67959/enter)                                 |
| 19 сентября |  03   | <ul><li>Библиотека numpy и матрично-векторные вычисления</li></ul>                                  | [Введение в numpy](Seminars/03-numpy/numpy.ipynb)                                      | [Контест 3: Векторизация вычислений с помощью библиотеки Numpy](https://contest.yandex.ru/contest/68403/enter) |
| 26 сентября |  04   | <ul><li>Введение в обработку изображений</li><li>Обсуждения задания 1 на KNN</li></ul>              | [Обработка изображений, KNN](Seminars/04-image-processing-and-KNN)                     | [Задание 1: Метрические алгоритмы классификации](Tasks/Task-01/task_01.pdf)                                    |
| 03 октября  |  05   | <ul><li>Подготовка отчётов</li><li>Система TeX</li></ul>                                            | [Подготовка отчётов](Seminars/05-reports-tex)                                          | ＼(٥⁀▽⁀ )／                                                                                                    |
| 10 октября  |  06   | <ul><li>Основы ООП</li><li>Декораторы</li><li>Исключения</li><li>typing</li></ul>                   | [Основы ООП](Seminars/06-classes/classes.ipynb)                                        | ＼(٥⁀▽⁀ )／                                                                                                    |
| 17 октября  |  07   | <ul><li>Проектирование кода</li><li>Шаблоны проектирования</li></ul>                                | [Проектирование кода](Seminars/07-oop/oop.ipynb)                                       | [Контест 4: Декораторы, итераторы, классы](https://contest.yandex.ru/contest/69835/enter)                      |
| 24 октября  |  08   | <ul><li>Введение в обработку текстов</li><li>Обсуждение задания 2 на лог. рег.</li></ul>            | [Введение в обработку текстов](Seminars/08-text-processing-and-logreg/seminar.pdf)     | [Задание 2: Градиентные методы обучения линейных моделей](Tasks/Task-02/task_02.pdf)                           |
| 31 октября  |  09   | <ul><li>Инструменты разработчика (часть 1)</li><li>VM, SSH, GIT</li><liGitFlow</li></ul>            | [Базовые инструменты разработчика](Seminars/09-dev-tools/dev_tools.ipynb)              | ＼(٥⁀▽⁀ )／                                                                                                    |
|  07 ноября  |  10   | <ul><li>Инструменты разработчика (часть 2)</li><li>Виртуальные окружения и контейнеры</li></ul>     | [Виртуальные окружения и контейнеры](Seminars/10-environments/environments.ipynb)      | ＼(٥⁀▽⁀ )／                                                                                                    |
|  14 ноября  |  11   | <ul><li>Основы веб-разработки (введение)</li></ul>                                 | [Материалы](Seminars/11-intro-web/)                                                                     | ＼(٥⁀▽⁀ )／                                                                                                    |
|  21 ноября  |  12   | <ul><li>Создание приложений с помощью FastAPI + Streamlit</li></ul>                                 | [Пример проекта](https://github.com/voorhs/example-project)                            | [Задание 3: Ансамбли алгоритмов для решения задачи регрессии. Веб-приложение](Tasks/Task-03/task.pdf)          |
|  28 ноября  |  13   | <ul><li>Асинхронное программирование. `aiogram` </li></ul>                                          | [Слайды](Seminars/13-aiogram/slides.pdf) [tg bot](https://github.com/voorhs/example-project/blob/tg-bot/bot.py)        | ＼(٥⁀▽⁀ )／                                                                 |
| 05 декабря  |  14   | <ul><li>Ctypes</li></ul>                                                                            | [Ctypes](Seminars/14-ctypes)                                                           | ＼(٥⁀▽⁀ )／                                                                                                    |
| 12 декабря  |  15   | <ul><li>Методы повышения эффективности</li></ul>                                                    | [Методы повышения эффективности](Seminars/15-efficiency/efficiency.ipynb)              | ＼(٥⁀▽⁀ )／                                                                                                    |
