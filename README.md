...
|  21 ноября  |  12   | <ul><li>Создание приложений с помощью FastAPI + Streamlit</li></ul>                                 | [в процессе]                                                                           | [Задание 3: Ансамбли алгоритмов для решения задачи регрессии. Веб-приложение](Tasks/Task-03/task.pdf)                                    |
